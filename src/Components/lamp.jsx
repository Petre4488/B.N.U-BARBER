    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30%] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30%] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-[16%] -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15%" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30%] -translate-y-[7rem] bg-cyan-400 "></motion.div>
